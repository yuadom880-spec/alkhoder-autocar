...
export const GOOGLE_REVIEWS: CustomerReview[] = [
  {
    id: 'review-12',
    name: 'TAWY',
    date: 'تقييم على Google',
    rating: 5,
    isNew: true,
    text: 'خذت من المكتب يارس جديد ممشاها ١٤ كم فقط، السياره بسم الله تبارك الله نظيفه، والصدق جيت أأجر من المكتب على السمعه الطيبه للموظف عبدالرحمن السنوسي، وبعد التعامل معه الرجل بشوش ومضياف وخدوم ومتفاعل على كل الاستفسارات واسلوبه ودي بالكلام ترتاح وانت تتعامل معه، واجهة طيبه للمكتب الله يوفقه يا رب ويكتب لهم الخير على يده',
  },
  {
    id: 'review-1',
    name: 'Yamen Alagey',
