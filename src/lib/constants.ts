...
export const SITE_META_AUTHOR = 'يوسف عصام'
export const SITE_DESIGNER_NAME = 'المهندس يوسف عصام'
export const SITE_COPYRIGHT_NOTICE = `© ${SITE_COPYRIGHT_YEAR} ${SITE_COMPANY_NAME}. جميع الحقوق محفوظة.`
export const SITE_DESIGN_CREDIT = `تصميم وتطوير: ${SITE_DESIGNER_NAME}`
